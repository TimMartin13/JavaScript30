...
const oldest = inventors.filter(inventor => (inventor.year >= 1500 && inventor.year < 1600));
console.log(oldest);
...
// Put NodeList into an array using the spread operator
...
const transport = data.reduce((obj, item) => {
    // If the item doesn't exist yet, initialize it
    if (!obj[item]) { obj[item] = 0; }
    // One more instance of the item
    obj[item]++;
    return obj;    
}, {});
